<template>
	<view class="diy-notice" :style="{padding: itemData.style.paddingTop + 'px' + ' 10px', background: itemData.style.background}" @click="gotoPage(item)">
	  ...
	  <view class="notice-text text-ellipsis flex-1">
		...
		<marquee broadcastType='text' direction="left" :broadcastIconIsDisplay="true" :touchEvent="true" :broadcastData='broadcastData' :broadcastStyle='broadcastStyle' >
		</marquee>
	  </view>
	</view>
</template>
...
<style>
	...
	.diy-notice .notice-text{ margin-left: 10px; font-size: 28rpx; overflow: hidden;}
	.diy-notice .notice-text text{ white-space: nowrap;}
</style>
