	...
	<view class="product-detail" v-if="!loadding">
		...
		<view class="product-pic">
			<swiper class="swiper" :indicator-dots="indicatorDots" :autoplay="autoplay" :interval="interval" :duration="duration">
				<swiper-item v-for="(item,index) in imagList" :key="index">
		...
		<view class="product-comment">
			<view class="group-hd">
				<view class="left"><text class="min-name">评价</text><text class="num">({{detail.comment_data_count}}条)</text></view>
		...
		<view class="share-box">
			<button type="primary" @click="showShare">
		...
		<view class="btns-wrap">
			...
			<view class="icon-box d-c-c" @click="gotocart">
				<button class="pr icon iconfont icon-gouwuche"><text v-if="cart_total_num>0" class="num">{{cart_total_num}}</text></button>
			</view>
			<template>
