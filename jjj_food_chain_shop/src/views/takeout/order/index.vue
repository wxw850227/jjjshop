						...
						<template #default="scope">
							<div v-if="!scope.row.is_top_row">
								<el-button @click="addClick(scope.row)" type="text" size="small"
									v-auth="'/takeout/order/detail'">订单详情
								</el-button>
								<el-button
									...
									v-auth="'/takeout/Operate/refund'">退款
								</el-button>
								<el-button
									...
									v-auth="'/takeout/operate/orderCancel'">取消
								</el-button>
								<el-button
									...
									v-auth="'/takeout/operate/extract'">核销
								</el-button>
								<el-button
									...
									@click="verifyClick(scope.row)" type="text" size="small"
									v-auth="'/takeout/operate/extract'">确认送达
								</el-button>
								...
								<el-button
									...
									v-auth="'/takeout/order/wxDelivery'">小程序发货</el-button>
							</div>
						</template>
					</el-table-column>
				</el-table>
	...
	export default {
		...
		methods: {
			...
			onExport: function() {
				...
				window.location.href = baseUrl + '/index.php/shop/takeout.operate/export?' + qs.stringify(this
					.searchForm);
			},
			/*打开取消*/
			cancelClick(item) {
